...
import { StaffMember } from '@/lib/data/about';
...
export default function EditStaffClient({ staffMember }: EditStaffClientProps) {
  return (
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-[#4f4865] font-onest mt-1">
                Update {staffMember.name}'s information
              </p>
            </div>
            <Link
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl border border-[#dbeafe] shadow-sm p-8">
          <StaffMemberForm
            staffMember={staffMember}
            onSubmit={() => {
              window.location.href = '/admin/about/team';
            }}
          />
        </div>
      </main>
